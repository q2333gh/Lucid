...
idl_value *idl_value_principal(idl_arena *arena, const uint8_t *data,
                               size_t len) {
...
idl_value *idl_value_record(idl_arena *arena, idl_value_field *fields,
                            size_t len) {
...
idl_value *idl_value_variant(idl_arena *arena, uint64_t index,
...
idl_value *idl_value_nat_bytes(idl_arena *arena, const uint8_t *leb_data,
                               size_t len) {
...
idl_value *idl_value_int_bytes(idl_arena *arena, const uint8_t *sleb_data,
                               size_t len) {
