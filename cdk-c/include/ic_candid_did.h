...
// Provides macros to embed candid interface in WASM for extraction by
// dfx/candid-extractor
#pragma once
...
//   2. An exported function exclusive func name called: `get_candid_pointer`
//   that returns the string address
// =============================================================================
