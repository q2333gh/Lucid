...
Two modes:
  ...
  1) Encode: read Candid text from stdin, run both C encoder and `didc encode`,
     compare hex outputs.
       ...
       echo '("hello", 42)' | ./compare.py encode \
...
def main() -> None:
    ...
    p_enc.add_argument("--c-bin", default="./c_candid_encode")
    ...
    p_dec.add_argument("--c-bin", default="./c_candid_decode")
